...
var instance = new Razorpay({
    key_id: 'rzp_test_EguMJjJ929dgCa',
    key_secret: 'lOnOiGeRH5UVfIcnUTkQ3LYy',
});
module.exports = {
    doSignup: (userData) => {
    ...
    verifyPayment: (details) => {
        return new Promise((resolve, reject) => {
            ...
            let hmac = crypto.createHmac('sha256', 'lOnOiGeRH5UVfIcnUTkQ3LYy')
    ...
    // changeNewPassword: (userData, userId) => {
