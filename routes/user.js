...
router.get('/user-details/:id', verifyLogin, async (req, res) => {
  let userDetails = await userHelpers.getUserDetails(req.params.id)
  console.log(userDetails);
  res.render('user/user-details', { user: req.session.user, userDetails })
})
router.post('/new-password/:id', (req, res) => {
  userHelpers.changeNewPassword(req.body).then((response) => {
    console.log(response);
    res.redirect('/')
  })
})
